...
public class SchematronSchemaFactoryTest {
	...
	public void validateFailure() throws Exception {
		try {
			...
			StreamSource xmlSource = new StreamSource("/xsd/xsd_schema_factory/shiporderUnvalid.xml");
...
Use the repository http://repository-uglisch.forge.cloudbees.com/release and declare the dependency
